...
// SAU_MATOCL_INODE_BY_PATH
SAUNAFS_DEFINE_PACKET_VERSION(matocl, inodeByPath, kStatusPacketVersion, 0)
SAUNAFS_DEFINE_PACKET_VERSION(matocl, inodeByPath, kResponsePacketVersion, 1)

SAUNAFS_DEFINE_PACKET_SERIALIZATION(
		matocl, inodeByPath, SAU_MATOCL_INODE_BY_PATH, kStatusPacketVersion,
		uint32_t, messageId,
		uint8_t, status)

SAUNAFS_DEFINE_PACKET_SERIALIZATION(
		matocl, inodeByPath, SAU_MATOCL_INODE_BY_PATH, kResponsePacketVersion,
		uint32_t, messageId,
		uint32_t, inode)
