...
*-o sfsignoregetxattr=0|1*::
Ignore getxattr by returning empty XattrReply to simulate correct response
immediately, without requesting any extended attribute info to master server.
