...
assert_eventually_prints 1 'saunafs_probe_master list-tapeservers | wc -l'
...
assert_equals 0 $(saunafs fileinfo file | grep "tape replica" | wc -l)
saunafs setgoal tape file
assert_eventually_prints 1 'sfsfileinfo file | grep "tape replica 1: OK" | wc -l'
