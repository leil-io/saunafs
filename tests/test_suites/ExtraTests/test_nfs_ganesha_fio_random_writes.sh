...
fio --name=fiotest_random_write --directory=${TEMP_DIR}/mnt/ganesha --size=200M --rw=randwrite --numjobs=5 --ioengine=libaio --group_reporting --bs=4M --direct=1 --iodepth=4
